package net.app1epi.tutorialmod.datagen;

import net.app1epi.tutorialmod.TutorialMod;
...
public class ModRecipeProvdier extends FabricRecipeProvider {
    public ModRecipeProvdier(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
    ...
    public void generate(RecipeExporter recipeExporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAW_PINK_GARNET, 9)
                ...
                .offerTo(recipeExporter, Identifier.of(TutorialMod.MOD_ID, "raw_pink_garnet_from_block"));
    }
}
